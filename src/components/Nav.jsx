  ...
  <ul className="nav">
    ...
    <div>
      ...
      <article className="contact">
        ...
        <a href="https://twitter.com/tmikeschu" target="_blank" rel="noopener noreferrer"><img src="http://icons.iconarchive.com/icons/uiconstock/socialmedia/512/Twitter-icon.png" alt="twitter"/></a>
      </article>
    </div>
  </ul>
)
