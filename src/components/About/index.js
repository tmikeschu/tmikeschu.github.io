...
const About = () => (
  <article className="About">
    <img className="About__image" src="https://www.turing.io/sites/default/files/styles/graduate_full_profile/public/IMG_0689-1_0.jpg?itok=MI9LeK3w" alt="profile"/>
    ...
    <p className="About__content">
      ...
      </a>. Hand-rolled styling with flexboxes, media queries, and BEM conventions.
    </p>
  </article>
)
